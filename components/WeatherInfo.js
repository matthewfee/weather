...
const WeatherInfo = ({
  ...
  <div
    className={`m-0 relative flex-col items-center justify-between flex-nowrap px-0 md:px-8 text-white w-full h-fill transition-all duration-[1000ms] ease-in  ${
  ...
  >
    {weather && (
      <div className="details-container flex justify-center items-center w-full px-0 mx-0">
        <ul className="weather-details md:mt-4 flex flex-row justify-center items-center gap-0 md:h-20 h-16 md:p-2 rounded-md bg-slate-600/25 w-full mx-0 shadow-sm shadow-black/25">
    ...
    <div className="weather-container-main md:px-4 flex flex-row flex-wrap justify-evenly items-center h-48">
      {temperature && (
